...
fn test_anchor2() {
    ...
    assert_eq!(md, "\n\n[CLOCKWORK](https://mechanikadesign.com)[STEAM](https://www.mechanikadesign.com)\n\n")
}
...
fn test_image() {
    ...
    assert_eq!(md, "\n\n[![Ferret](https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Ferret_2008.png/220px-Ferret_2008.png)](https://example.com/over/there?name=ferret)  \n\n")
}
