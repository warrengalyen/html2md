...
pub mod android {
    ...
    #[no_mangle]
    pub unsafe extern fn Java_com_mechanikadesign_html2md_Html2Markdown_parse(env: JNIEnv, _clazz: JClass, html: JString) -> jstring {
    ...
    #[no_mangle]
    pub unsafe extern fn Java_com_mechanikadesign_html2md_Html2Markdown_parseExtended(env: JNIEnv, _clazz: JClass, html: JString) -> jstring {
        let html_java : String = env.get_string(html).expect("Couldn't get java string!").into();
